...
```
   ...
   - #### 2.3 Morphological operations
     ...
     <img src="content/output/Segmented.png" alt="Binary image output after segmentation and morphological operations" width="300"/>
      ...
      <img src="content/output/Contoured.jpg" alt="Histological image with vessel contours overlayed" width="300"/>
...
## Aknowledgements
This project was partially funded by the Italian Ministry of Health Ricerca Finalizzata GR-2021-12373209.
